 ...
 *
 * Fact extraction for tooling that must answer within a keystroke: a single
 * pass per file, no dependencies, no AST allocation beyond the tokens a caller
 * asked for. Measured against @shopify/liquid-html-parser on five production
